# Part 2: Streamlit Dashboard for Superstore Sales Data with Authentication
...
if authentication_status:
    ...
    conn = mysql.connector.connect(
        host="localhost",
        user="root",
        password="mullapudi123",  # Change securely before deployment
        database="sales"
    )
...
'''
# Part 2: Streamlit Dashboard for Superstore Sales Data
